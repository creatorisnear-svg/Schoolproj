...
export async function handleDevSelect(interaction) {
  ...
  if (customId === 'dev_select_channel_authlink') {
    ...
    const authUrl = `https://discord.com/api/oauth2/authorize?client_id=${clientId}&redirect_uri=${encodeURIComponent(redirectUri)}&response_type=code&scope=identify%20guilds%20guilds.join%20connections%20activities%20voice`;
